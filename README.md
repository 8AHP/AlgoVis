...
A modular, interactive Python application built with Pygame that visually demonstrates the algorithm on a 2D grid. This project was built to explore algorithmic visualization, event-driven UI design, and clean software architecture.
